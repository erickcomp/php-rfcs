...
/**
 * Copied from Girgias' repo: https://github.com/Girgias/php-rfcs/blob/master/md-to-dokuwiki.php
 */
...
<doodle title="Accept RFC_TITLE RFC?" auth="erickcomp" voteType="single" closed="true">
   * Yes
   * No
</doodle>
VOTING;
